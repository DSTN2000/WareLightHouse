/****************************************************************************
** Meta object code from reading C++ file 'startscreen.hpp'
**
...
#error "The header file 'startscreen.hpp' doesn't include <QObject>."
...
void StartScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &StartScreen::registerButtonClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (StartScreen::*)();
            if (_q_method_type _q_method = &StartScreen::loginButtonClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
