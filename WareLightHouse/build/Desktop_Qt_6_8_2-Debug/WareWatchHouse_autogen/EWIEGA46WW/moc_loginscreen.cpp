/****************************************************************************
** Meta object code from reading C++ file 'loginscreen.hpp'
**
...
#error "The header file 'loginscreen.hpp' doesn't include <QObject>."
...
void LoginScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->openRegisterScreen(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (LoginScreen::*)(const QString & , const QString & );
        ...
        }
        {
            ...
            if (_q_method_type _q_method = &LoginScreen::registerRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginScreen::loginSuccessful(const QString & _t1, const QString & _t2)
{
